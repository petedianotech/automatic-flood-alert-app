    ...
    >
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-[#E1E3E1] dark:border-[#303134]">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {!isArmed ? (
                <span className="px-2.5 py-0.5 rounded-full text-xs font-semibold bg-[#F1F3F4] text-[#5F6368] dark:bg-[#2D2E30] dark:text-[#9AA0A6]">
                  Sensor Off
                </span>
              ) : isPaused ? (
                ...
                <span className="px-2.5 py-0.5 rounded-full text-xs font-bold bg-[#FCE8E6] text-[#D93025] dark:bg-[#D93025]/20 dark:text-[#F28B82] border border-[#FAD2CF] dark:border-[#D93025]/40">
                  Bell Alarm Active
                </span>
              ) : isYellowActive ? (
                <span className="px-2.5 py-0.5 rounded-full text-xs font-bold bg-[#FEF7E0] text-[#B06000] dark:bg-[#B06000]/20 dark:text-[#FDD663] border border-[#FEEFC3] dark:border-[#B06000]/40">
                  Bell Warning Active
                </span>
              ) : (
        ...
        <div className="flex items-center gap-2 self-start sm:self-center">
          <div className="px-3.5 py-2 rounded-2xl bg-[#F8F9FA] dark:bg-[#28292A] border border-[#E1E3E1] dark:border-[#303134] text-right font-mono">
            <span className="text-[10px] font-bold text-[#5F6368] dark:text-[#9AA0A6] block leading-tight">
              Bell Match
            </span>
            <span
      ...
      <div
        className={`p-3.5 rounded-2xl border flex items-center justify-between gap-3 text-xs transition-colors ${
          !isArmed
            ? 'bg-[#F8F9FA] dark:bg-[#28292A] border-[#E1E3E1] dark:border-[#303134] text-[#5F6368]'
            : isBellDetected
            ? 'bg-[#E6F4EA] text-[#0D652D] border-[#CEEAD6] dark:bg-[#137333]/20 dark:text-[#81C995] dark:border-[#137333]/40'
            : isVoiceRejected
            ? 'bg-[#FEF7E0] text-[#B06000] border-[#FEEFC3] dark:bg-[#B06000]/20 dark:text-[#FDD663] dark:border-[#B06000]/40'
            : isWhistleRejected
            ? 'bg-[#FEF7E0] text-[#B06000] border-[#FEEFC3] dark:bg-[#B06000]/20 dark:text-[#FDD663] dark:border-[#B06000]/40'
            : 'bg-[#F8F9FA] dark:bg-[#28292A] border-[#E1E3E1] dark:border-[#303134] text-[#5F6368] dark:text-[#9AA0A6]'
        }`}
      >
        <div className="flex items-center gap-2.5 min-w-0">
          {isBellDetected ? (
            ...
            <Activity className="w-4 h-4 text-[#5F6368] dark:text-[#9AA0A6] shrink-0" />
          )}
      ...
      <div className="space-y-1.5">
        <div className="flex items-center justify-between text-xs text-[#5F6368] dark:text-[#9AA0A6] font-medium">
          <span className="text-[#B06000] dark:text-[#FDD663] font-bold">
            &larr; Voice Filter (Ignored)
          </span>
          <span className="text-[#137333] dark:text-[#81C995] font-bold">
            Bell Resonance (Detected) &rarr;
          </span>
        </div>

        {/* 32 Frequency Bars */}
        <div className="h-12 w-full bg-[#F8F9FA] dark:bg-[#121316] rounded-2xl p-1.5 flex items-end justify-between gap-0.5 border border-[#E1E3E1] dark:border-[#303134]">
          {soundData.frequencyData && soundData.frequencyData.length > 0 ? (
            ...
            <div className="w-full text-center text-[10px] text-[#5F6368] dark:text-[#9AA0A6] my-auto">
              Standby
            </div>
          )}
        </div>
      ...
      <div className="p-4 rounded-2xl bg-[#F8F9FA] dark:bg-[#28292A] border border-[#E1E3E1] dark:border-[#303134] space-y-2">
        ...
        <div className="h-3 w-full bg-[#E1E3E1] dark:bg-[#303134] rounded-full overflow-hidden p-0.5 relative">
          <div
        ...
        <div className="flex justify-between text-[11px] text-[#5F6368] dark:text-[#9AA0A6] font-medium">
          ...
          <span className="text-[#B06000] dark:text-[#FDD663] font-bold">{thresholdYellowDb} dB Warning</span>
          <span className="text-[#D93025] dark:text-[#F28B82] font-bold">{thresholdRedDb} dB Alarm</span>
