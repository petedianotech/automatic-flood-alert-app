...
export const MALAWI_RIVER_STATION_PRESETS: Array<{
...
}> = [
  {
    ...
    name: 'Sensor #1: Ruo River (Dzenje, T/A Mabuka)',
    riverName: 'Ruo River',
    village: 'Dzenje Village',
    traditionalAuthority: 'T/A Mabuka',
    district: 'Mulanje',
  ...
  {
    id: 'station_likhubula_chitakale',
    name: 'Sensor #2: Likhubula River (Chitakale / Mulanje Mountain Basin)',
    riverName: 'Likhubula River',
    village: 'Chitakale Village',
    traditionalAuthority: 'T/A Laston Njema',
    district: 'Mulanje',
    region: 'Southern Region, Malawi',
    defaultCoords: { lat: -15.9622, lng: 35.5240 },
  },
  {
    id: 'station_muloza_border',
    name: 'Sensor #3: Muloza River Basin (Muloza Border Post)',
    riverName: 'Muloza River',
    village: 'Muloza Border',
    traditionalAuthority: 'T/A Mabuka',
    district: 'Mulanje',
    region: 'Southern Region, Malawi',
    defaultCoords: { lat: -16.0520, lng: 35.6180 },
  },
  {
    id: 'station_phalombe_mkhumba',
    name: 'Sensor #4: Phalombe River (T/A Mkhumba)',
    riverName: 'Phalombe River',
    village: 'Migowi Basin',
    traditionalAuthority: 'T/A Mkhumba',
    district: 'Phalombe',
    region: 'Southern Region, Malawi',
    defaultCoords: { lat: -15.8030, lng: 35.6510 },
  },
  {
    id: 'station_shire_chikwawa',
    name: 'Sensor #5: Lower Shire River (Kasinthula Basin)',
    riverName: 'Shire River',
    village: 'Kasinthula Village',
    traditionalAuthority: 'T/A Katunga',
    district: 'Chikwawa',
    region: 'Southern Region, Malawi',
    defaultCoords: { lat: -16.0289, lng: 34.8211 },
  },
];
